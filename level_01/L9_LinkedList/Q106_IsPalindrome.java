...
public class Q106_IsPalindrome {
    public static class Node {
      ...
      public static class LinkedList {
        ...
        private boolean isPalindromeHelper(Node nodeRight){
          if(nodeRight==null) return true;
    
          boolean rres=isPalindromeHelper(nodeRight.next);
          if(rres==false){
            return false;
          }else if(nodeRight.data != left.data) return false;
