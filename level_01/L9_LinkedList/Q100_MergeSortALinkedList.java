...
public class Q100_MergeSortALinkedList {
    public static class Node {
      ...
      public static class LinkedList {
        ...
        public static LinkedList mergeSort(Node head, Node tail){
          ...
          Node n= midNode(head, tail);
          LinkedList l1= mergeSort(head, n);
          LinkedList l2= mergeSort(n.next, tail);
          LinkedList fl= mergeTwoSortedLists(l1, l2);
          return fl;
        }
      }
