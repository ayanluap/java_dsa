...
public class Q131_IsBalancedTree {
    public static class Node {
      ...
      public static int isBstBalanced(Node node){
        if(node == null) return 0;
    
        int lside= isBstBalanced(node.left);
        int rside= isBstBalanced(node.right);
    
        if(Math.abs(lside-rside) > 1) isBal= false;
